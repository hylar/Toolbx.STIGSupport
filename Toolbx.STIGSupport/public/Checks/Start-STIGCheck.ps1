        ...
        Try {
            ...
            if ($SCAPBenchmark) {
                ...
                if ($SCAP.RuleID -contains $ruleID) {
                    ...
                    if ($scapResult -eq "fail" -and $check.Status -eq "NotAFinding") {
                    ...
                    elseif ($scapResult -eq "pass" ) {

                        # Update Checklist
                        Set-ChecklistItem -Checklist $CKL -VulnID $check.VulnID -Details $PassedSCAPFinding -Status "NotAFinding"
