<#
.SYNOPSIS
    This checks for compliancy on V-73789.
...
Write-Verbose "[$($MyInvocation.MyCommand)]Checking - V-73789"
...
Write-Verbose "[$($MyInvocation.MyCommand)] Completed Checking - V-73789 [$($Results.Status)]"
