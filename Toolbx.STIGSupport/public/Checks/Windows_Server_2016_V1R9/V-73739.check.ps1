<#
.SYNOPSIS
    This checks for compliancy on V-73739.
...
Write-Verbose "[$($MyInvocation.MyCommand)]Checking - V-73739"
...
$right=$PreCheck.userRights -match "SeInteractiveLogonRight"
if(!$right){
...
Write-Verbose "[$($MyInvocation.MyCommand)] Completed Checking - V-73739 [$($Results.Status)]"
