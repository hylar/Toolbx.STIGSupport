<#
.SYNOPSIS
    This checks for compliancy on V-73781.
...
Write-Verbose "[$($MyInvocation.MyCommand)]Checking - V-73781"
...
$right=$PreCheck.userRights -match "SeRemoteShutdownPrivilege"
if(!$right){
...
Write-Verbose "[$($MyInvocation.MyCommand)] Completed Checking - V-73781 [$($Results.Status)]"
