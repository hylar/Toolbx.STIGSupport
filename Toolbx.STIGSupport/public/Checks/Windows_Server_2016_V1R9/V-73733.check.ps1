<#
.SYNOPSIS
    This checks for compliancy on V-73733.
...
Write-Verbose "[$($MyInvocation.MyCommand)]Checking - V-73733"
...
Write-Verbose "[$($MyInvocation.MyCommand)] Completed Checking - V-73733 [$($Results.Status)]"
